/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*
  ...
  https://www.codewars.com/kata/sorting-on-planet-twisted-3-7/train/javascript
...
function sortTwisted37(array) {
  function swap(value) {
    return Number(value.toString().replace(/[3, 7]/g, function(x) {
      return x == 7 ? 3 : 7;
    }));
  }
  return array.map(swap).sort(function(a, b) {return a - b;}).map(swap);
}
