/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*
  ...
  https://www.codewars.com/kata/especially-joyful-numbers/train/javascript
...
function numberJoy(n) {
  var s = n.toString().split('').reduce(function(a, b) {return Number(a) + Number(b)});
  return s * Number(s.toString().split('').reverse().join('')) === n;
}
