/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*
  ...
  https://www.codewars.com/kata/the-mean-of-two-means/train/javascript
...
function getMean(arr, x, y) {
  if (x > arr.length || x <= 1) return -1;
  if (y > arr.length || y <= 1) return -1;
  var xMean = arr.slice(0, x).reduce(function(a, b) {
    return (a + b) / 2;
  });
  var yMean = arr.reverse().slice(0, y).reduce(function(a, b) {
    return (a + b) / 2;
  });
