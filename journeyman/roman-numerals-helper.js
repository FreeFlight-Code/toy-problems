/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*
  ...
  to and from an integer value. The class should follow the API 
  ...
  2000=MM, 8=VIII; or MMVIII. 1666 uses each Roman symbol in 
...
RomanNumerals = new Object();

RomanNumerals.prototype.toRoman = function(x) {
  console.log('hi');
  return x;
};