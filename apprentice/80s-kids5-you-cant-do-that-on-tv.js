/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*
  80s KIDS #5: YOU CAN'T DO THAT ON TELEVISION
  https://www.codewars.com/kata/80-s-kids-number-5-you-cant-do-that-on-television/train/javascript
...
function bucketOf(str) {
  function saidWaterWords() {
    return /(water|wash|wet)/i.test(str);
  }
  function saidSlimeWords() {
    return /(I don\'t know|slime)/i.test(str);
  }
  return saidWaterWords() && saidSlimeWords() ? 'sludge' : saidWaterWords() ? 'water' : saidSlimeWords() ? 'slime' : 'air';
}
